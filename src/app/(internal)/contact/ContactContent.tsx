...
export default function ContactContent({ siteSettings }: { siteSettings: SiteSettings }) {
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-danphe-primary via-danphe-dark to-danphe-primary py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center">
          ...
          >
            {siteSettings.address || 'Imark Digital Pvt. Ltd. (Danphe)'}<br />
            Email: {siteSettings.email || 'info@danphecare.com'}
          </motion.p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mb-12 flex flex-wrap justify-center gap-8 text-sm text-danphe-text-light">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href={`mailto:${siteSettings.email || ''}`} className="hover:text-danphe-accent">{siteSettings.email || ''}</a>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="overflow-hidden rounded-2xl border border-danphe-border">
              {siteSettings.mapEmbedUrl ? (
                ...
                <div className="flex items-center justify-center bg-danphe-bg-light" style={{ minHeight: '450px' }}>
                  <p className="text-danphe-text-light">Map not available</p>
                </div>
              )}
            </div>
          </div>
