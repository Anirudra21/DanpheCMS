...
type TeamMember = { name: string; title: string; photoUrl: string };
...
export default function CompanyContent({ stats, team }: { stats: StatItem[]; team: TeamMember[] }) {
  return (
    <>
      {/* Hero Banner */}
                ...
                <Card className="group h-full overflow-hidden border-danphe-border text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                  <CardContent className="p-0">
                    ...
                    <div className="p-4 pb-5">
                      ...
                      <p className="mt-1.5 whitespace-pre-line text-xs leading-relaxed text-danphe-text-light sm:text-sm">{member.title}</p>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
